...
public class Ex5 extends JFrame {
    ...
    public Ex5(){
        ...
        addFirst.addActionListener(e->{
            ...
            curAdd.setText((Integer.valueOf(Integer.parseInt(curAdd.getText())+1)).toString());
        ...
        playButton.addActionListener(e->{
            JOptionPane.showMessageDialog(this, new Ex2(firstStart.getText(), secondStart.getText()).play());
            firstStart.setText("");
            secondStart.setText("");
            curAdd.setText("0");
